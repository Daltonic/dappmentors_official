...
<head>
    ...
    <title>Verify Your Email - Dapp Mentors</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                Welcome to <strong>Dapp Mentors</strong>! We are a dedicated Blockchain Academy and community passionate about guiding developers, entrepreneurs, and technologists into the world of Web3 and decentralized applications (dApps).
            </div>
            
            <div class="verification-card">
                <h3>📧 Verification Email Sent</h3>
                <p>We've sent a verification link to your email address. Check your inbox and click the verification link to activate your account.</p>
            </div>
            ...
            <div class="security-notice">
                <p><strong>⚠️ Important:</strong> This verification link will expire in 24 hours for security reasons. If you didn't create an account with Dapp Mentors, please ignore this email.</p>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <div class="disclaimer">
                ...
                <br>
                You're receiving this email because you created an account at dappmentors.org
            </div>
        </div>
    </div>
</body>
